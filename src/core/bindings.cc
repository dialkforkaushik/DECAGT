...
PYBIND11_MODULE(decagt, m) {
    ...
    py::class_<FiniteElementExteriorCalculus, GeometryComplex>(m, "FiniteElementExteriorCalculus")
        ...
        .def("compute_bb_mass_matrices", &FiniteElementExteriorCalculus::compute_bb_mass_matrices, py::call_guard<py::gil_scoped_release>())
        ...
        .def("M_alpha_beta", &FiniteElementExteriorCalculus::M_alpha_beta)
        .def("S_n", &FiniteElementExteriorCalculus::S_n)
        .def("grad_B", &FiniteElementExteriorCalculus::grad_B)
        .def("phi_FT", &FiniteElementExteriorCalculus::phi_FT)
        .def("psi_T", &FiniteElementExteriorCalculus::psi_T)
        .def("bernstein", &FiniteElementExteriorCalculus::bernstein)
        .def("omega_ij", &FiniteElementExteriorCalculus::omega_ij)
        .def("chi_l", &FiniteElementExteriorCalculus::chi_l)
        .def("curl_phi_FT", &FiniteElementExteriorCalculus::curl_phi_FT)
        .def("curl_psi_T", &FiniteElementExteriorCalculus::curl_psi_T)
        .def("upsilon", &FiniteElementExteriorCalculus::upsilon)
