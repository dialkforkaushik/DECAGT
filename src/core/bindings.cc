...
PYBIND11_MODULE(decagt, m) {
    ...
    py::class_<FiniteElementExteriorCalculus, GeometryComplex>(m, "FiniteElementExteriorCalculus")
        ...
        .def("grad_B", &FiniteElementExteriorCalculus::grad_B, py::call_guard<py::gil_scoped_release>())
        .def("phi_FT", &FiniteElementExteriorCalculus::phi_FT, py::call_guard<py::gil_scoped_release>())
        .def("psi_T", &FiniteElementExteriorCalculus::psi_T, py::call_guard<py::gil_scoped_release>())
        .def("bernstein", &FiniteElementExteriorCalculus::bernstein, py::call_guard<py::gil_scoped_release>())
        .def("omega_ij", &FiniteElementExteriorCalculus::omega_ij, py::call_guard<py::gil_scoped_release>())
